...
class Advanceb extends StatefulWidget {
  @override
  _AdvancebState createState() => _AdvancebState();
}

class _AdvancebState extends State<Advanceb> {
  Razorpay razorpay;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          Image.asset("assets/images/advanceb.jpg"),
          Container(
