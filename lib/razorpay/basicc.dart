...
class Basicc extends StatefulWidget {
  @override
  _BasiccState createState() => _BasiccState();
}

class _BasiccState extends State<Basicc> {
  Razorpay razorpay;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          Image.asset("assets/images/basicc.jpg"),
          Container(
