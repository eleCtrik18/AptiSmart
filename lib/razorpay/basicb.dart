...
class Basicb extends StatefulWidget {
  @override
  _BasicbState createState() => _BasicbState();
}

class _BasicbState extends State<Basicb> {
  Razorpay razorpay;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          Image.asset("assets/images/basicb.jpg"),
          Container(
